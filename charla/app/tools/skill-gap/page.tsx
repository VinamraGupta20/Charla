    ...
    >
      <div className="flex flex-col gap-4">
        <div className="flex flex-col gap-1.5">
          ...
          <input className="input" placeholder="e.g. Senior Frontend Engineer, Data Scientist..."
            value={form.target_role} onChange={(e) => update("target_role", e.target.value)} />
        </div>
        <div className="grid grid-cols-2 gap-4 max-sm:grid-cols-1">
          <div className="flex flex-col gap-1.5">
            <label className="text-sm font-medium" style={{ color: "var(--foreground)" }}>Years of Experience</label>
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-sm font-medium" style={{ color: "var(--foreground)" }}>Your Timeline</label>
        ...
        <div className="flex flex-col gap-1.5">
          <label className="text-sm font-medium" style={{ color: "var(--foreground)" }}>Your Current Skills & Experience</label>
          <textarea
            className="input min-h-[280px] max-sm:min-h-[200px] resize-none"
