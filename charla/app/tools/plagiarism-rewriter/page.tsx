    ...
    >
      <div className="flex flex-col gap-4">
        <div className="flex flex-col gap-2">
          <label className="text-sm font-medium" style={{ color: "var(--foreground)" }}>Rewriting Style</label>
        ...
        <div className="flex flex-col gap-1.5">
          <label className="text-sm font-medium" style={{ color: "var(--foreground)" }}>Subject / Context (optional)</label>
        ...
        <div className="flex flex-col gap-1.5">
          <label className="text-sm font-medium" style={{ color: "var(--foreground)" }}>Text to Rewrite</label>
          <textarea
          ...
          />
          <p className="text-xs" style={{ color: "var(--muted-foreground)" }}>{form.text.length} characters</p>
        </div>
