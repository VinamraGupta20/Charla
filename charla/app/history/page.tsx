  ...
  const renderOutput = (text: string) => {
    return text.split("\n").map((line, i) => {
      if (line.startsWith("### ") || line.startsWith("## ")) {
        return (
          <p key={i} className="font-semibold text-sm mt-4 mb-1" style={{ color: "var(--text-primary)" }}>
            {line.replace(/^#{2,3}\s/, "")}
          </p>
        );
      }
      if (/^\d+\.\s\*\*(.+)\*\*/.test(line)) {
        return (
          <p key={i} className="font-semibold text-sm mt-3" style={{ color: "var(--text-primary)" }}>
            {line.replace(/\*\*/g, "")}
          </p>
        );
      }
      if (line.startsWith("- ") || line.startsWith("• ")) {
        return (
          <p key={i} className="text-sm ml-4" style={{ color: "var(--text-secondary)" }}>
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col gap-0.5">
                          ...
                          <p className="text-xs line-clamp-1 max-w-[400px]" style={{ color: "var(--text-tertiary)" }}>
                      ...
                      <div className="px-4 pb-4 pt-2 border-t" style={{ borderColor: "var(--border-default)" }}>
                        <div className="mb-4">
                          ...
                          <div
                            ...
                            style={{ backgroundColor: "var(--bg-overlay)", color: "var(--text-secondary)", border: "1px solid var(--border-default)" }}
                          >
                  ...
                  {isExpanded && (
                    <div className="px-4 pb-4 pt-2 border-t" style={{ borderColor: "var(--border-default)" }}>
                      ...
                      {insights ? (
                        ...
                        <div
                          className="rounded-lg p-3 text-xs flex items-center gap-2 mb-2"
                      ...
                      <p className="text-xs font-medium uppercase tracking-wide mb-3 mt-5" style={{ color: "var(--text-tertiary)" }}>
                          ...
                          {[...transcript].reverse().map((message, idx) => (
                            ...
                            >
                              ...
                              <div
                                ...
                                style={{
                                  backgroundColor: message.role === "user" ? "var(--accent-muted)" : "var(--bg-overlay)",
